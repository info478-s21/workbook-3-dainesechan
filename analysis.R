...
#Yes. We can see that an increase in DALYs negatively effects life expectancy,
#This means that people with higher dalys are more likely to have shorter life
#expectancy. As a result, it is reasonable to say that when people live longer,
...
#Change in life expectancy has almost direct correlation with change in HALE.
#This means that if life expectancy increases, health-adjusted life expectancy
#will also increase.
